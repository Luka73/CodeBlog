...
public class DummyData {
    ...
    public void savePosts(){
        ...
        Post post3 = new Post();
        post3.setAutor("Usagi Tsukino");
        post3.setData(LocalDate.now());
        post3.setTitulo("Moon Soldiers");
        ...
        Post post4 = new Post();
        post4.setAutor("Luana Fernandes");
        post4.setData(LocalDate.now());
        post4.setTitulo("Thymeleaf");
        post4.setTexto("Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.");
